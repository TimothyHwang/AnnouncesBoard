<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MP.Master"
    CodeBehind="BBContent.aspx.vb" Inherits="AnnouncesBoard.BBContent" %>
        ...
        <tr>
            <td>
                ...
                <table class="style1">
                        ...
                        <td>
                            <table style="margin: 0px auto 0px auto">
                                ...
                                <tr>
                                    ...
                                    <td class="style1">
                                        <asp:TextBox ID="txtCo_Word" runat="server" CssClass="Area" AutoCompleteType="Disabled"></asp:TextBox>
                                    </td>
                                    <td class="style1">
                                        &nbsp;字&nbsp;
                                    </td>
                                    <td class="style1">
                                        <asp:TextBox ID="txtCo_SNO" runat="server" CssClass="Area" AutoCompleteType="Disabled"></asp:TextBox>
                                        &nbsp;號&nbsp;
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr class="style3">
                        <td class="style3">
                            人員模式：不需插上單位憑證卡即可進入系統，查詢瀏覽第三類公文。<asp:DropDownList ID="ddlOr_orgname" runat="server"
                    ...
                    <tr class="style3">
                        <td class="style3">
                            單位模式：請先插上單位憑證卡，經過驗證合法後即進入系統，查詢預覽第三類公文，可下載傳送。
                        </td>
                    </tr>
                    <tr align="right">
                        <td>
                            <div class="Button_Up" id="divDownBtn" runat="server">
                    ...
                    <tr class="style2">
                        <td class="style2">
                            <cc1:MarkGridView runat="server" ID="gvList" class="style2" AutoGenerateColumns="False"
                                ...
                                EnableModelValidation="True" CellPadding="1" EmptyDataText="無資料.">
                                ...
                                <Columns>
                                    <asp:BoundField DataField="or_orgname" HeaderText="發文機關">
                                        ...
                                        <HeaderStyle BackColor="#4F74AA" BorderColor="Gray" BorderWidth="1px" ForeColor="White"
                                            Width="320px" VerticalAlign="Middle" />
                                        <ItemStyle HorizontalAlign="Center" Font-Size="11pt" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="co_dtype" HeaderText="文別" ControlStyle-Font-Size="11pt">
                                        <ControlStyle Width="120px" />
                                        <HeaderStyle BackColor="#4F74AA" BorderColor="Gray" BorderWidth="1px" ForeColor="White"
                                            Width="120px" />
                                        <ItemStyle HorizontalAlign="Center" Width="120px" Font-Size="11pt" />
                                    </asp:BoundField>
