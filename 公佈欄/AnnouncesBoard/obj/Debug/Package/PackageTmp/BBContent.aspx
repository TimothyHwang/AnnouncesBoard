...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function dowork() {
            ...
            //指定iframe的src並將其設為隱藏
            $iframe.attr('src', 'ForceDownloadFile.aspx').css('display', 'none');
            $('body').append($iframe);
        }
    </script>
                        ...
                        <td>
                            <table style="margin: 0px auto 0px auto">
                                ...
                                <tr>
                                    ...
                                    <td class="style1">
                                        <asp:TextBox ID="txtCo_Word" runat="server" CssClass="Area" 
                                            AutoCompleteType="Disabled" Width="140px"></asp:TextBox>
                                    </td>
                                    <td class="style1">
                                        字
                                    </td>
                                    <td class="style1">
                                        <asp:TextBox ID="txtCo_SNO" runat="server" CssClass="Area" 
                                            AutoCompleteType="Disabled" Width="140px"></asp:TextBox>
                                    </td>
                                    <td width="20px" class="style1">
                                        號
                                    ...
                                    <td class="style1">
                                        &nbsp;
                                        <asp:CheckBox ID="ckbGuideFlag" runat="server" Text="政令宣導" />
                                    </td>
                                    <td class="style1">
                                        &nbsp;
                                    </td>
                            ...
                            <cc1:MarkGridView runat="server" ID="gvList" class="style2" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="狀態" ControlStyle-Font-Size="11pt">
                                        <ItemTemplate>
                                            <asp:Label ID="lblIsDownload" runat="server" />
