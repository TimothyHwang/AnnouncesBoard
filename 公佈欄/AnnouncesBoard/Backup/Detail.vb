...
Public Class Detail
    ...
    Public Function LoadSeqnoDetail(ByVal Seqno As String)
        ...
        Dim cmd As New OracleCommand("select o.or_orgname, c.co_dtype, c.co_issudt, c.co_postdt, c.co_postnm, c.co_seqno, c.co_subj, c.co_word, c.co_sno, co_path from organ o,content c where o.or_orgno = c.co_orgno and c.co_seqno =  :co_seqno", Conn)
    ...
    Public Function LoadPathDetail(ByVal Path As String)
        Conn.Open()
        Dim dr As OracleDataReader
        Dim cmd As New OracleCommand("select o.or_orgname, c.co_dtype, c.co_issudt, c.co_postdt, c.co_postnm, c.co_seqno, c.co_subj, c.co_word, c.co_sno, co_path from organ o,content c where o.or_orgno = c.co_orgno and c.co_path = :co_path", Conn)
