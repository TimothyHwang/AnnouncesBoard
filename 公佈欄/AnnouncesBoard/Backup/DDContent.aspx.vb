...
Public Class DDContent
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Session("LoginMode") = 2 Then
            ...
            '持續檢查卡片狀態
            'Dim Script As String = "setInterval('CheckCard()',1000);"
    ...
    Protected Sub btnSearch_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnSearch.Click
        ...
        Dim dt As DataTable = PublicFunc.Search(txtOr_orgname.Text, txtCo_Subj.Text, txtCo_Word.Text, txtCo_SNO.Text, strDate, endDate, strDate1, endDate1, False)
    ...
    Private Sub gvList_RowDeleting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewDeleteEventArgs) Handles gvList.RowDeleting
        Dim hid_CO_WORD As HiddenField = gvList.Rows(e.RowIndex).FindControl("hid_CO_WORD")
        Dim hid_CO_SNO As HiddenField = gvList.Rows(e.RowIndex).FindControl("hid_CO_SNO")
        Dim hidCO_PATH As HiddenField = gvList.Rows(e.RowIndex).FindControl("hidCO_PATH")
        Dim SqlCmd As String
        Dim oe As New Basic
        SqlCmd = String.Format("delete from ATTACH where AT_PATH ='{0}'", hidCO_PATH.Value)
        oe.ODataExecute(SqlCmd)
        SqlCmd = String.Format("delete from CONTENT where CO_SNO ='{0}' and CO_WORD='{1}'", hid_CO_SNO.Value, hid_CO_WORD.Value)
        oe.ODataExecute(SqlCmd)
        Response.Redirect("DDcontent.aspx")
